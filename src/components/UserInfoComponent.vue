...
const rules = reactive({
  ...
  // mileAge: [{ required: true, message: '此字段为必填项', trigger: 'change' }, {
  //   pattern: /^[0-9]*$/, message: '积分不能更改', trigger: 'change'
  // }],
...
<template>
  <div style="display: flex; flex-direction: column">
    ...
    <el-form ref="ruleFormRef" :model="form" :rules="rules" label-width="30%" class="demo-ruleForm" label-position="right"
      ...
      <el-form-item label="积分" prop="mileAge">
        <el-input v-model="form.mileAge" style="width: 25vh" :disabled="true" />
      </el-form-item>
